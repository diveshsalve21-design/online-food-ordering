...
export const categories = [
  { key: "indian", label: "Indian Food", emoji: "🍛", image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?auto=format&fit=crop&w=1000&q=95" },
  { key: "biryani", label: "Biryani", emoji: "🍲", image: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&w=1000&q=95" },
  { key: "pizza", label: "Pizza", emoji: "🍕", image: "https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=1000&q=95" },
  { key: "burger", label: "Burgers", emoji: "🍔", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=1000&q=95" },
  { key: "chinese", label: "Chinese", emoji: "🍜", image: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?auto=format&fit=crop&w=1000&q=95" },
  { key: "healthy", label: "Healthy", emoji: "🥗", image: "https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=1000&q=95" },
  { key: "dessert", label: "Desserts", emoji: "🍰", image: "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=1000&q=95" },
];

export const dishes = [
  // 🍲 AUTHENTIC BIRYANI SPECIALS (100% VERIFIED BIRYANI PHOTOS)
  { id: "spice-biryani", restaurantId: "spice-route", name: "Hyderabadi Dum Biryani", desc: "Aromatic basmati rice, saffron spices and tender chicken slow-cooked in dum pot.", price: 379, veg: false, category: "biryani", calories: 760, time: 30, image: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&w=1000&q=95" },
  { id: "biryani-lucknowi-mutton", restaurantId: "spice-route", name: "Lucknowi Mutton Dum Biryani", desc: "Royal Awadhi style dum biryani with marinated tender lamb pieces & kewra rice.", price: 449, veg: false, category: "biryani", calories: 820, time: 32, image: "https://images.unsplash.com/photo-1633945274405-b6c8069047b0?auto=format&fit=crop&w=1000&q=95" },
  { id: "biryani-royal-veg", restaurantId: "spice-route", name: "Royal Veg Dum Biryani", desc: "Fragrant basmati rice layered with garden vegetables, paneer cubes, cashews & fried onions.", price: 299, veg: true, category: "biryani", calories: 580, time: 25, image: "https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?auto=format&fit=crop&w=1000&q=95" },
  { id: "biryani-egg-dum", restaurantId: "spice-route", name: "Special Egg Dum Biryani", desc: "Hard-boiled eggs tossed in rich biryani masala gravy with saffron long grain basmati rice.", price: 259, veg: false, category: "biryani", calories: 610, time: 22, image: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&w=1000&q=95" },
  { id: "biryani-kolkata-chicken", restaurantId: "spice-route", name: "Kolkata Special Chicken Biryani", desc: "Classic Kolkata style biryani with spiced potato, boiled egg, & marinated chicken.", price: 389, veg: false, category: "biryani", calories: 740, time: 28, image: "https://images.unsplash.com/photo-1631515243349-e0cb75fb8d3a?auto=format&fit=crop&w=1000&q=95" },
  { id: "biryani-paneer-tikka", restaurantId: "spice-route", name: "Paneer Tikka Dum Biryani", desc: "Smoky tandoori paneer tikka cubes layered with aromatic basmati rice & mint raita.", price: 339, veg: true, category: "biryani", calories: 630, time: 26, image: "https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?auto=format&fit=crop&w=1000&q=95" },

  // 🇮🇳 AUTHENTIC INDIAN FOOD SPECIALS
  { id: "indian-chole-bhature", restaurantId: "spice-route", name: "Amritsari Chole Bhature", desc: "Spiced chickpeas served with fluffy fried bhature, pickles & onions.", price: 189, veg: true, category: "indian", calories: 590, time: 20, image: "https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?auto=format&fit=crop&w=1000&q=85" },
  { id: "indian-butter-chicken", restaurantId: "spice-route", name: "Delhi Style Butter Chicken", desc: "Tender tandoori chicken simmered in rich creamy tomato butter gravy.", price: 389, veg: false, category: "indian", calories: 680, time: 25, image: "https://images.unsplash.com/photo-1588166524941-3bf61a9c41db?auto=format&fit=crop&w=1000&q=85" },
  { id: "spice-paneer", restaurantId: "spice-route", name: "Paneer Butter Masala", desc: "Charred paneer cubes in a rich tomato and cashew gravy.", price: 319, veg: true, category: "indian", calories: 540, time: 28, image: "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&w=1000&q=85" },
  { id: "spice-dal", restaurantId: "spice-route", name: "Dal Makhani", desc: "Slow-cooked black lentils finished with butter and cream.", price: 249, veg: true, category: "indian", calories: 430, time: 25, image: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&w=1000&q=85" },
  { id: "spice-naan", restaurantId: "spice-route", name: "Butter Garlic Naan", desc: "Clay-oven bread brushed with garlic butter.", price: 79, veg: true, category: "indian", calories: 230, time: 12, image: "https://images.unsplash.com/photo-1610057099431-d73a1c9d2f2f?auto=format&fit=crop&w=1000&q=85" },
  { id: "spice-kebab", restaurantId: "spice-route", name: "Tandoori Chicken Kebab", desc: "Yoghurt-marinated chicken, charred in the tandoor.", price: 349, veg: false, category: "indian", calories: 510, time: 25, image: "https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=1000&q=85" },
  { id: "coastal-prawn-curry", restaurantId: "coastal-curry", name: "Konkan Prawn Curry", desc: "Coastal prawns simmered in a fragrant coconut and kokum curry.", price: 429, veg: false, category: "indian", calories: 520, time: 28, image: "https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=1000&q=85" },
  { id: "coastal-fish-fry", restaurantId: "coastal-curry", name: "Crispy Surmai Fry", desc: "Spiced king mackerel fried crisp and served with fresh salad.", price: 389, veg: false, category: "indian", calories: 460, time: 24, image: "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&w=1000&q=85" },
  { id: "bistro-pav-bhaji", restaurantId: "bombay-bistro", name: "Butter Pav Bhaji", desc: "Rich mashed vegetable bhaji served with buttered pav.", price: 189, veg: true, category: "indian", calories: 510, time: 18, image: "https://images.unsplash.com/photo-1626132647523-66f5bf380027?auto=format&fit=crop&w=1000&q=85" },
  { id: "indian-rajma-chawal", restaurantId: "spice-route", name: "Special Rajma Chawal Bowl", desc: "Home-style red kidney bean curry served with fragrant basmati rice.", price: 199, veg: true, category: "indian", calories: 450, time: 18, image: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&w=1000&q=85" },
  { id: "indian-malai-kofta", restaurantId: "spice-route", name: "Creamy Malai Kofta Curry", desc: "Soft paneer & dry fruit dumplings in velvety cashew saffron gravy.", price: 319, veg: true, category: "indian", calories: 560, time: 24, image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?auto=format&fit=crop&w=1000&q=85" },
  { id: "indian-palak-paneer", restaurantId: "spice-route", name: "Garlic Palak Paneer", desc: "Fresh spinach puree cooked with paneer & tempered garlic butter.", price: 299, veg: true, category: "indian", calories: 420, time: 20, image: "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=1000&q=85" },

  // 🍕 PIZZA & ITALIAN SPECIALS
  { id: "napoli-margherita", restaurantId: "napoli", name: "Truffle Margherita Pizza", desc: "Wood-fired pizza with basil, fresh mozzarella and truffle oil.", price: 349, veg: true, category: "pizza", calories: 620, time: 25, image: pizza },
  ...
  { id: "bistro-vada-pav", restaurantId: "bombay-bistro", name: "Mumbai Vada Pav", desc: "Spiced potato fritter in a soft pav with dry garlic chutney.", price: 119, veg: true, category: "burger", calories: 350, time: 12, image: "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=1000&q=85" },
  ...
  { id: "green-smoothie", restaurantId: "green-bowl", name: "Mango Protein Smoothie", desc: "Mango, oats and plant protein blended cold.", price: 199, veg: true, category: "healthy", calories: 280, time: 10, image: "https://images.unsplash.com/photo-1623065422902-30a2d299bcc4?auto=format&fit=crop&w=1000&q=85" },
  ...
  { id: "indian-jalebi-rabri", restaurantId: "sweet-tooth", name: "Hot Jalebi with Rabri", desc: "Crispy saffron jalebis served with thick chilled rabri.", price: 149, veg: true, category: "dessert", calories: 410, time: 15, image: "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=1000&q=85" },
...
export const restaurants = [
  ...
  { id: "coastal-curry", name: "Coastal Curry House", cuisine: "Seafood · Konkan", rating: 4.7, time: "25–35 min", distance: "2.8 km", price: 259, veg: false, discount: "15% OFF", image: "https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=1000&q=95" },
  { id: "bombay-bistro", name: "Bombay Street Bistro", cuisine: "Street Food · Indian", rating: 4.5, time: "15–25 min", distance: "1.9 km", price: 129, veg: true, discount: "Free delivery", image: "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=1000&q=95" },
];

export const getRestaurant = (id?: string) => restaurants.find((restaurant) => restaurant.id === id);
export const getRestaurantDishes = (restaurantId: string) => dishes.filter((dish) => dish.restaurantId === restaurantId);

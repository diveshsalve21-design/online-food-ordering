...
export const dishes = [
  ...
  { id: "indian-paneer-tikka-masala", restaurantId: "spice-route", name: "Paneer Tikka Masala", desc: "Charred cottage cheese cubes in spiced onion tomato masala gravy.", price: 329, veg: true, category: "indian", calories: 540, time: 22, image: "https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?auto=format&fit=crop&w=1000&q=85" },
  ...
  { id: "indian-aloo-kulcha", restaurantId: "spice-route", name: "Amritsari Stuffed Aloo Kulcha", desc: "Crispy tandoori kulcha stuffed with spiced potatoes & butter.", price: 149, veg: true, category: "indian", calories: 380, time: 15, image: "https://images.unsplash.com/photo-1626074353765-517a681e40be?auto=format&fit=crop&w=1000&q=85" },
  ...
  { id: "indian-roti-basket", restaurantId: "spice-route", name: "Tandoori Roti Basket (4 Pcs)", desc: "Fresh clay oven baked whole wheat tandoori rotis brushed with butter.", price: 99, veg: true, category: "indian", calories: 280, time: 10, image: "https://images.unsplash.com/photo-1610057099431-d73a1c9d2f2f?auto=format&fit=crop&w=1000&q=85" },
  ...
  { id: "indian-sweet-lassi", restaurantId: "spice-route", name: "Punjabi Sweet Lassi", desc: "Creamy churned yoghurt drink topped with malai & pistachios.", price: 99, veg: true, category: "indian", calories: 260, time: 8, image: "https://images.unsplash.com/photo-1623065422902-30a2d299bcc4?auto=format&fit=crop&w=1000&q=85" },

  // PIZZA & WESTERN DISHES
  ...
  { id: "coastal-prawn-curry", restaurantId: "coastal-curry", name: "Konkan Prawn Curry", desc: "Coastal prawns simmered in a fragrant coconut and kokum curry.", price: 429, veg: false, category: "biryani", calories: 520, time: 28, image: "https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=1000&q=85" },
  { id: "coastal-fish-fry", restaurantId: "coastal-curry", name: "Crispy Surmai Fry", desc: "Spiced king mackerel fried crisp and served with fresh salad.", price: 389, veg: false, category: "biryani", calories: 460, time: 24, image: "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&w=1000&q=85" },
  ...
  { id: "bistro-pav-bhaji", restaurantId: "bombay-bistro", name: "Butter Pav Bhaji", desc: "Rich mashed vegetable bhaji served with buttered pav.", price: 189, veg: true, category: "biryani", calories: 510, time: 18, image: "https://images.unsplash.com/photo-1626132647523-66f5bf380027?auto=format&fit=crop&w=1000&q=85" },
...
export const restaurants = [
  ...
  { id: "coastal-curry", name: "Coastal Curry House", cuisine: "Seafood · Konkan", rating: 4.7, time: "25–35 min", distance: "2.8 km", price: 259, veg: false, discount: "15% OFF", image: "https://images.unsplash.com/photo-1559847844-5315695dadae?auto=format&fit=crop&w=1000&q=85" },
  { id: "bombay-bistro", name: "Bombay Street Bistro", cuisine: "Street Food · Indian", rating: 4.5, time: "15–25 min", distance: "1.9 km", price: 129, veg: true, discount: "Free delivery", image: "https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=1000&q=85" },
];

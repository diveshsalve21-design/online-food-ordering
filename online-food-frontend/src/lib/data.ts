...
export const dishes = [
  // 🍲 AUTHENTIC BIRYANI SPECIALS (6 UNIQUE DISTINCT BIRYANI PHOTOS)
  ...
  { id: "biryani-paneer-tikka", restaurantId: "spice-route", name: "Paneer Tikka Dum Biryani", desc: "Smoky tandoori paneer tikka cubes layered with aromatic basmati rice & mint raita.", price: 339, veg: true, category: "biryani", calories: 630, time: 26, image: biryani },

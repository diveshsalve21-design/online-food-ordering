...
import { r as inr } from "./cart-qRuWGf-q.mjs";
import { t as Button } from "./button-DRsC1qZi.mjs";
import { t as Input } from "./input-DicJzR9-.mjs";
import { H as LogOut, M as Plus, Q as DollarSign, _ as Star, b as ShoppingBag, dt as Bike, f as TrendingUp, i as X, j as Power, lt as Building2, ot as ChefHat, rt as CircleCheck, s as Users, tt as Clock } from "../_libs/lucide-react.mjs";
import { t as Textarea } from "./textarea-DBn9CRiI.mjs";
import { i as saveActiveHotel, r as getActiveHotel, t as DEFAULT_5_HOTELS } from "./login-Dn4VTafF.mjs";
import { t as Label } from "./label-B4PTMSG2.mjs";
import { t as Badge } from "./badge-Cc0IblCb.mjs";
import { r as getFoodImageFallback } from "./data-C9guypz_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/dashboard-CQNlPYSV.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var HOTEL_SPECIFIC_DISHES_MAP = {
	"Divesh Salve": [
		{
			id: "divesh-1",
...
function HotelDashboard() {
	...
	const [activeHotel, setActiveHotel] = (0, import_react.useState)(null);
	const [menuList, setMenuList] = (0, import_react.useState)([]);
	const [orders, setOrders] = (0, import_react.useState)([]);
	const [showAddDishModal, setShowAddDishModal] = (0, import_react.useState)(false);
	const [newDishName, setNewDishName] = (0, import_react.useState)("");
	const [newDishPrice, setNewDishPrice] = (0, import_react.useState)("");
	const [newDishVeg, setNewDishVeg] = (0, import_react.useState)(true);
	const [newDishDesc, setNewDishDesc] = (0, import_react.useState)("");
	const [newDishImage, setNewDishImage] = (0, import_react.useState)("");
	...
	const setupHotelDashboardData = (hotel) => {
		const key = Object.keys(HOTEL_ORDERS_MAP).find((k) => k.toLowerCase().includes(hotel.ownerName.split(" ")[0].toLowerCase()));
		const initialOrders = key ? HOTEL_ORDERS_MAP[key] : HOTEL_ORDERS_MAP["Divesh Salve"];
		setOrders(initialOrders);
		const dishKey = Object.keys(HOTEL_SPECIFIC_DISHES_MAP).find((k) => k.toLowerCase().includes(hotel.ownerName.split(" ")[0].toLowerCase()));
	...
	const handleSwitchHotel = (h) => {
		saveActiveHotel(h);
		setActiveHotel(h);
		setupHotelDashboardData(h);
		toast.success(`Switched to ${h.ownerName}'s Dashboard! 🏬`, { description: h.hotelName });
	};
	...
	const toggleAvailability = (id, name) => {
	...
	const handleCreateDishSubmit = (e) => {
		...
		toast.success(`🎉 "${newDishObj.name}" Added to ${activeHotel?.hotelName} Menu!`, { description: `Price: ${inr(newDishObj.price)} · Available Live for Customers` });
		setNewDishName("");
		setNewDishPrice("");
		setNewDishDesc("");
		setNewDishImage("");
	...
	const hotelRating = (4.6 + seed % 4 * .1).toFixed(1);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mx-auto max-w-7xl px-4 pb-16 pt-6 sm:px-6 space-y-6",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "glass-strong rounded-3xl p-4 border border-white/15 shadow-glow flex flex-wrap items-center justify-between gap-3",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-2 text-xs font-black text-primary uppercase tracking-wider",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Users, { className: "h-4 w-4 text-secondary" }), " Switch Hotel Dashboard (5 Partners):"]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex flex-wrap gap-2",
					children: DEFAULT_5_HOTELS.map((h) => {
						const isActive = activeHotel?.ownerName === h.ownerName;
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
							onClick: () => handleSwitchHotel(h),
							className: `rounded-2xl px-3 py-1.5 text-xs font-bold transition-all cursor-pointer border ${isActive ? "border-primary bg-primary text-black shadow-glow" : "border-white/10 bg-white/5 text-muted-foreground hover:bg-white/10 hover:text-white"}`,
							children: [
								h.ownerName,
								" (",
								h.hotelName.split(" ")[0],
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "glass-strong flex flex-wrap items-center justify-between gap-4 rounded-3xl p-6 border border-white/10 shadow-glow",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							children: activeHotel ? `${activeHotel.hotelName} Partner Hub` : "Hotel Partner Hub"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
							className: "rounded-full bg-emerald-500/20 text-emerald-400 border-emerald-500/30 font-bold",
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: activeHotel?.ownerName
							}),
							" · Email:",
							" ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-semibold text-secondary",
								children: activeHotel?.email
							}),
							" · ",
							activeHotel?.address || "Kalyan"
						]
					})] })]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "glass rounded-3xl p-5 border border-white/10 space-y-1",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-between text-xs text-muted-foreground",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Orders Today" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingBag, { className: "h-4 w-4 text-primary" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-2xl font-black text-foreground",
								children: ordersToday
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center text-[10px] text-emerald-400 font-semibold",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrendingUp, { className: "mr-1 h-3 w-3" }), " +22% vs yesterday"]
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-between text-xs text-muted-foreground",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Today's Revenue" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DollarSign, { className: "h-4 w-4 text-emerald-400" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-2xl font-black text-foreground",
								children: inr(revenueToday)
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-between text-xs text-muted-foreground",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Avg Kitchen Prep Time" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "h-4 w-4 text-secondary" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "text-2xl font-black text-foreground",
								children: [prepTimeMin, " mins"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-[10px] text-muted-foreground",
								children: "Optimal kitchen speed"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-between text-xs text-muted-foreground",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Hotel Rating" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: "h-4 w-4 text-amber-400 fill-amber-400" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "text-2xl font-black text-foreground",
								children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "glass-strong rounded-3xl p-6 border border-white/10 space-y-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChefHat, { className: "h-5 w-5 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
							className: "text-lg font-black text-foreground",
							children: ["Live Incoming Orders for ", activeHotel?.hotelName]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
						variant: "outline",
						className: "rounded-full border-white/10 text-xs font-bold",
						children: [orders.filter((o) => o.status !== "Delivered").length, " Active Orders"]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "space-y-3",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										className: `rounded-full text-[10px] font-bold ${order.status === "Pending" ? "bg-amber-500/20 text-amber-400" : order.status === "Preparing" ? "bg-blue-500/20 text-blue-400" : order.status === "Out for delivery" ? "bg-purple-500/20 text-purple-400" : "bg-emerald-500/20 text-emerald-400"}`,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: ["Total: ", inr(order.total)]
									})
								] })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChefHat, { className: "mr-1 h-3 w-3" }), " Preparing"]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
										size: "sm",
										...
										className: "rounded-xl text-[11px] h-8 font-bold cursor-pointer",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bike, { className: "mr-1 h-3 w-3" }), " Out for Delivery"]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
										size: "sm",
										...
										className: "rounded-xl text-[11px] h-8 font-bold cursor-pointer",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "mr-1 h-3 w-3" }), " Delivered"]
									})
								]
							})
						]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
						className: "text-lg font-black text-foreground",
						children: [activeHotel?.hotelName, " Menu & Stock Management"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-xs text-muted-foreground",
						children: [
							"Unique signature menu items for ",
							activeHotel?.ownerName,
							"'s restaurant."
						]
					})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						size: "sm",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "mr-1 h-3.5 w-3.5" }), " Add New Dish"]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "grid gap-3 sm:grid-cols-2 lg:grid-cols-3",
					children: menuList.map((dish) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								...
								onError: (e) => {
									...
									e.currentTarget.src = getFoodImageFallback(dish.name.toLowerCase().includes("pizza") ? "pizza" : dish.name.toLowerCase().includes("pasta") ? "pasta" : dish.name.toLowerCase().includes("biryani") ? "biryani" : "sides");
								},
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "font-bold text-xs text-foreground truncate flex items-center gap-1",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: dish.name }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `h-2 w-2 rounded-full shrink-0 ${dish.veg ? "bg-emerald-500" : "bg-rose-500"}` })]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Power, { className: "mr-1 h-3 w-3" }),
									" ",
			...
			showAddDishModal && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in-50",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "glass-strong relative w-full max-w-md rounded-3xl border border-white/15 p-6 shadow-2xl space-y-4",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
										...
										className: "flex rounded-xl border border-white/10 bg-white/5 p-1 h-10",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											type: "button",
											onClick: () => setNewDishVeg(true),
											className: `flex-1 rounded-lg text-xs font-bold transition-colors cursor-pointer ${newDishVeg ? "bg-emerald-500/20 text-emerald-400" : "text-muted-foreground"}`,
											children: "🥦 Veg"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											type: "button",
											onClick: () => setNewDishVeg(false),
											className: `flex-1 rounded-lg text-xs font-bold transition-colors cursor-pointer ${!newDishVeg ? "bg-rose-500/20 text-rose-400" : "text-muted-foreground"}`,
											children: "🍗 Non-Veg"
										})]
									})]
								})]
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
									className: "text-xs font-semibold uppercase text-muted-foreground",
									children: "Dish Image URL (Optional)"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "mr-1 h-4 w-4" }), " Save & Publish Dish Live"]
							})
						]
					})]
				})
...
//#endregion
export { HotelDashboard as component };
